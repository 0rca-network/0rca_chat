...
class Orchestrator {
    ...
    async selectAgentsAutomatically(prompt, agents) {
...
`;
        ...
        try {
            ...
            const ids = Array.isArray(result) ? result : result.agentIds || [];
...
User Task: "${prompt}"`
        ...
        const response = await this.mistral.chat.complete({
            ...
            messages: messages, // casting for simplicity in this snippet
            tools: agentTools,
            toolChoice: "auto"
        });
