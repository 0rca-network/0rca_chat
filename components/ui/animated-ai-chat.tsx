...
export function AnimatedAIChat() {
    ...
    const commandSuggestions: CommandSuggestion[] = [
        {
            ...
            prefix: "/architect",
            prompt: "Analyze the requirements and design a scalable, cloud-native architecture. Include diagrams for microservices, database schema, and API boundaries."
        },
        {
            ...
            prefix: "/review",
            prompt: "Conduct a thorough code review of the snippet. Identify security flaws, performance issues, and anti-patterns. Suggest modern refactoring improvements."
        },
        {
            ...
            prefix: "/test",
            prompt: "Write comprehensive Jest/React Testing Library tests for this component. Cover happy paths, edge cases, and user interactions."
        },
        {
            ...
            prefix: "/debug",
            prompt: "Analyze this error stack trace and code context. Diagnose the root cause of the race condition/bug and propose a thread-safe solution."
        },
    ];
    ...
    const selectCommandSuggestion = (index: number) => {
        ...
        const textToInsert = selectedCommand.prompt || (selectedCommand.prefix + ' ');
        setValue(textToInsert);
        setShowCommandPalette(false);
